...
These accounts are required for OpenCV image installation and configuration

## OpenCV

* OpenCV administrator username: `admin`
* OpenCV administrator password: stored in the file of your server */credentials/password.txt*
